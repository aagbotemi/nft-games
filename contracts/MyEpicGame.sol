...
contract MyEpicGame is ERC721 {
    ...
    // A lil array to help us hold the default data for our characters. This will be helpful when we mint new characters and need to know things like their HP, AD, etc.
    CharacterAttributes[] defaultCharacters;

    // We create a mapping from the nft's tokenId => that NFTs attributes.
    mapping(uint256 => CharacterAttributes) public nftHolderAttributes;

    // A mapping from an address => the NFTs tokenId. Gives me an ez way to store the owner of the NFT and reference it later.
    ...
    // Data passed in to the contract when it's first created initializing the characters. We're going to actually pass these values in from from run.js.
    constructor(
    ...
    function mintCharacterNFT(uint _characterIndex) external {
        ...
        // We map the tokenId => their character attributes. More on this in the lesson below.
    ...
    function checkIfUserHasNFT() public view returns (CharacterAttributes memory) {
        ...
        } else {// Else, return an empty character.
